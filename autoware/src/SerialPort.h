...
/** Helper class that handles the actual connection to AUTOWARE via serial port.
 *
 */
class SerialPort {
private:
   ...
   public:
	 ...
	 /** Reads speed.
	  *	 Requests speed from AUTOWARE device and returns it in m/s.
	  */
	 double readSpeed();

	 /** Reads rpm.
	  *	 Requests rpm from AUTOWARE device and returns it.
