...
public:
	...
	/** Receives MCMs from McService.
	 * Continuously receives MCMs generated by McService and enqueues them in the queue of the correct access category (VI).
	 * Before enqueuing, outdated MCMs are flushed from the queue.
	 * If a MCM is enqueued successfully, sendQueuedPackets() is called. Else, the queue is full and the MCM is dropped.
	 */
	void receiveFromMc();
...
private:
	...
	CommunicationReceiver* mReceiverFromMc;
	...
	boost::thread* mThreadReceiveFromMc;
